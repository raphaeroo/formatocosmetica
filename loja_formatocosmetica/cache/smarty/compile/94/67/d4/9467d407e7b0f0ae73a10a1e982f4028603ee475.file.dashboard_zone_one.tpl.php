<?php /* Smarty version Smarty-3.1.19, created on 2019-01-23 09:25:18
         compiled from "/home/temporarioagenci/formatocosm.temporario.agenciasense.com.br/modules/psaddonsconnect/views/templates/hook/dashboard_zone_one.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15894874445c484f1ee0f845-12893336%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9467d407e7b0f0ae73a10a1e982f4028603ee475' => 
    array (
      0 => '/home/temporarioagenci/formatocosm.temporario.agenciasense.com.br/modules/psaddonsconnect/views/templates/hook/dashboard_zone_one.tpl',
      1 => 1546536603,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15894874445c484f1ee0f845-12893336',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c484f1ef058b2_11300989',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c484f1ef058b2_11300989')) {function content_5c484f1ef058b2_11300989($_smarty_tpl) {?>
		                ...
		                <div class="modal-body">
		                    <div class="row">
		                        <div class="col-md-12">
		                            ...
		                            <form id="ps-addons-connect-form"  action="<?php echo htmlentities($_smarty_tpl->tpl_vars['url_connexion']->value, ENT_QUOTES, 'UTF-8', true);?>
" method="POST">
    ...
    <?php } else { ?>
		...
		<img src="<?php echo htmlentities($_smarty_tpl->tpl_vars['img_path']->value, ENT_QUOTES, 'UTF-8', true);?>
lamp-selection-moment.jpg" alt="lamp" class="pull-left">
		...
		<a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['link_advice']->value, ENT_QUOTES, 'UTF-8', true);?>
" target="_blank" class="pull-right"> <?php echo smartyTranslate(array('s'=>'See the entire selection','mod'=>'psaddonsconnect'),$_smarty_tpl);?>
 ...
 <a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['practical_links']->value['traffic'], ENT_QUOTES, 'UTF-8', true);?>
" target="_blank"> <?php echo smartyTranslate(array('s'=>'increase your traffic','mod'=>'psaddonsconnect'),$_smarty_tpl);?>
 ></a><br>
		<?php echo smartyTranslate(array('s'=>'Modules to','mod'=>'psaddonsconnect'),$_smarty_tpl);?>
 <a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['practical_links']->value['conversion'], ENT_QUOTES, 'UTF-8', true);?>
" target="_blank"> <?php echo smartyTranslate(array('s'=>'boost your conversions','mod'=>'psaddonsconnect'),$_smarty_tpl);?>
 ></a><br>
		<?php echo smartyTranslate(array('s'=>'Modules to','mod'=>'psaddonsconnect'),$_smarty_tpl);?>
 <a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['practical_links']->value['averageCart'], ENT_QUOTES, 'UTF-8', true);?>
" target="_blank"> <?php echo smartyTranslate(array('s'=>'increase your clients\' average cart','mod'=>'psaddonsconnect'),$_smarty_tpl);?>
 ...
 <a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['practical_links']->value['businessSector'], ENT_QUOTES, 'UTF-8', true);?>
