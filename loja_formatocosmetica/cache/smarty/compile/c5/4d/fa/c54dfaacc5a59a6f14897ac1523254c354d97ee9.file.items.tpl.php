<?php /* Smarty version Smarty-3.1.19, created on 2019-01-04 10:40:10
         compiled from "/home/temporarioagenci/formatocosm.temporario.agenciasense.com.br/modules/themeconfigurator/views/templates/admin/items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7989845625c2f542aa867a9-55038051%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c54dfaacc5a59a6f14897ac1523254c354d97ee9' => 
    array (
      0 => '/home/temporarioagenci/formatocosm.temporario.agenciasense.com.br/modules/themeconfigurator/views/templates/admin/items.tpl',
      1 => 1541073678,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7989845625c2f542aa867a9-55038051',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2f542ab02178_14638434',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2f542ab02178_14638434')) {function content_5c2f542ab02178_14638434($_smarty_tpl) {?>
...
?>
		<li id="lang-<?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" class="lang-flag<?php if ($_smarty_tpl->tpl_vars['lang']->value['id_lang']==$_smarty_tpl->tpl_vars['htmlitems']->value['lang']['default']['id_lang']) {?> active<?php }?>">
			<a href="#items-<?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
');" data-toggle="tab"><?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</a>
		</li>
	<?php } ?>
</ul>
...
?>
	<div id="items-<?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value, ENT_QUOTES, 'UTF-8', true);?>
...
?>
 ...
 "<?php echo htmlentities($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
"</h4>
...
?>
					<li id="item-<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['id_item'], ENT_QUOTES, 'UTF-8', true);?>
" class="item well">
						<form method="post" action="<?php echo htmlentities($_smarty_tpl->tpl_vars['htmlitems']->value['postAction'], ENT_QUOTES, 'UTF-8', true);?>
" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['htmlitems']->value['postAction'], ENT_QUOTES, 'UTF-8', true);?>
&amp;removeItem&amp;item_id=<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['id_item'], ENT_QUOTES, 'UTF-8', true);?>
" name="removeItem" class="link-item-delete">
							...
							<span class="item-order"><?php if ($_smarty_tpl->tpl_vars['hItem']->value['item_order']<=9) {?>0<?php }?><?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['item_order'], ENT_QUOTES, 'UTF-8', true);?>
</span>
							<span class="item-title"><?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
</span>
							<br>
...
" class="preview img-thumbnail" />
							...
							<div class="item-container clearfix">
								<input type="hidden" name="id_lang" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
								<input type="hidden" name="item_id" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['id_item'], ENT_QUOTES, 'UTF-8', true);?>
" />
								<input type="hidden" name="item_order" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['item_order'], ENT_QUOTES, 'UTF-8', true);?>
" />
								...
								<div class="title item-field form-group">
									...
									<div class="col-lg-7">
										<input type="text" name="item_title" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
" />
									</div>
								</div>
								...
								<div class="image_w item-field form-group">
									...
									<div class="col-lg-7">
										<div class="input-group fixed-width-lg">
											<input name="item_img_w" type="text" maxlength="4" size="4" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['image_w'], ENT_QUOTES, 'UTF-8', true);?>
"/>
								...
								<div class="image_h item-field form-group">
									...
									<div class="col-lg-7">
										<div class="input-group fixed-width-lg">
											<input name="item_img_h" type="text" maxlength="4" size="4" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['image_h'], ENT_QUOTES, 'UTF-8', true);?>
"/>
											<span class="input-group-addon"><?php echo smartyTranslate(array('s'=>'pixels'),$_smarty_tpl);?>
</span>
										</div>
								...
								<div class="url item-field form-group">
									...
									<div class="col-lg-7">
										<input type="text" name="item_url" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
" />
									</div>
								</div>
								...
								<div class="html item-field form-group">
									...
									<div class="col-lg-7">
										<textarea name="item_html" cols="65" rows="12"><?php echo htmlentities($_smarty_tpl->tpl_vars['hItem']->value['html'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
									</div>
								</div>
