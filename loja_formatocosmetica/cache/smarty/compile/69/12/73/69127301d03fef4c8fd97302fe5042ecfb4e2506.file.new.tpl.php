<?php /* Smarty version Smarty-3.1.19, created on 2019-01-04 10:40:10
         compiled from "/home/temporarioagenci/formatocosm.temporario.agenciasense.com.br/modules/themeconfigurator/views/templates/admin/new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2713785435c2f542aa58678-90821340%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '69127301d03fef4c8fd97302fe5042ecfb4e2506' => 
    array (
      0 => '/home/temporarioagenci/formatocosm.temporario.agenciasense.com.br/modules/themeconfigurator/views/templates/admin/new.tpl',
      1 => 1541073678,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2713785435c2f542aa58678-90821340',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2f542aa80776_95589081',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2f542aa80776_95589081')) {function content_5c2f542aa80776_95589081($_smarty_tpl) {?>
...
?>
								<?php if ($_smarty_tpl->tpl_vars['lang']->value['id_lang']==$_smarty_tpl->tpl_vars['htmlitems']->value['lang']['default']['id_lang']) {?> <?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['iso_code'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>
							<?php } ?>
							</span>
...
" class="new-lang-flag"><a href="javascript:setLanguage(<?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
, '<?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['iso_code'], ENT_QUOTES, 'UTF-8', true);?>
');"><?php echo htmlentities($_smarty_tpl->tpl_vars['lang']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</a></li>
							<?php } ?>
						</ul>
						<input type="hidden" id="lang-id" name="id_lang" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['htmlitems']->value['lang']['default']['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" />
					</div>
				</div>
